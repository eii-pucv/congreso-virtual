    ...
    var BootstrapTable = function () {
      ...
      _createClass(BootstrapTable, [{
        ...
        value: function initPagination() {
          ...
          if (o.sidePagination !== 'data_server.js') {
        ...
        value: function initBody(fixedScroll) {
          ...
          if (!this.options.pagination || this.options.sidePagination === 'data_server.js') {
            this.pageFrom = 1;
        ...
        value: function initServer(silent, query, url) {
          ...
          var request = $.extend({}, Utils.calculateObjectValue(null, this.options.ajaxOptions), {
            ...
            error: function error(jqXHR) {
              var data = [];
              if (_this9.options.sidePagination === 'data_server.js') {
                data = {};
