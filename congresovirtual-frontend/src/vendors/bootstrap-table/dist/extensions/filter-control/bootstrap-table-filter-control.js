  ...
  (function ($) {
    ...
    var UtilsFilterControl = {
      ...
      initFilterSelectControls: function initFilterSelectControls(that) {
        ...
        var z = that.options.pagination ? that.options.sidePagination === 'data_server.js' ? that.pageTo : that.options.totalRows : that.pageTo;
    ...
    $.BootstrapTable = function (_$$BootstrapTable) {
      ...
      _createClass(_class, [{
        ...
        value: function initSearch() {
          ...
          if (this.options.sidePagination === 'data_server.js') {
            return;
          }
        ...
        value: function EnableControls(enable) {
          if (this.options.disableControlWhenSearch && this.options.sidePagination === 'data_server.js') {
            var header = UtilsFilterControl.getCurrentHeader(this);
            var searchControls = UtilsFilterControl.getCurrentSearchControls(this);
