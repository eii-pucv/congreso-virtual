(function (global, factory) {
    ...
    (function ($) {
            ...
            if (!$(_id).hasClass("modal")) {
                ...
                that.$sortModal.off('click', '.btn-primary').on('click', '.btn-primary', function () {
                    ...
                    if (results.length > 0) {
                        ...
                        if (that.options.sidePagination === 'data_server.js') {
        ...
        BootstrapTable.prototype.initToolbar = function () {
            ...
            if (that.options.sidePagination === 'data_server.js' && !isSingleSort && that.options.sortPriority !== null) {
                var t = that.options.queryParams;
                that.options.queryParams = function (params) {
                    params.multiSort = that.options.sortPriority;
                    return t(params);
            ...
            if (this.options.showMultiSort) {
                ...
                this.$el.on('load-success.bs.table', function () {
                    if (!isSingleSort && that.options.sortPriority !== null && _typeof(that.options.sortPriority) === 'object' && that.options.sidePagination !== 'data_server.js') {
                        that.onMultipleSort();
                    }
                });
