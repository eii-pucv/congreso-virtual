...
var OPTIONS = {
  ...
  "prereq": [
    ...
    "definitions of global variables used throughout your projects",
    "string",
    null
  ],
  "exclude": ["exclude",
...
/**
 * Tries to find a configuration file in either projects directory
...
// lookups when liniting an entire projects
var findFileResults = {};
