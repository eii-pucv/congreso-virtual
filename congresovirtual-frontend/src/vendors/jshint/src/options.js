...
exports.bool = {
  enforcing: {
     ...
     *             check out [the JSCS
     *             projects](https://github.com/jscs-dev/node-jscs).
     */
    camelcase   : true,
  ...
  environments: {
     ...
     * tool](http://browserify.org/) to build a projects.
     */
    browserify  : true,
...
exports.val = {
   ...
   *             out [the JSCS projects](https://github.com/jscs-dev/node-jscs).
   */
  maxlen       : false,
   ...
   * projects-specific global variables.
   *
