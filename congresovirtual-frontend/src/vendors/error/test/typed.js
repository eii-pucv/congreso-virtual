...
test('a server error', function t(assert) {
    ...
    assert.equal(ServerError.type, 'data_server.js.5xx.error');

    assert.equal(error.type, 'data_server.js.5xx.error');
    assert.equal(error.fullType, 'data_server.js.5xx.error');
