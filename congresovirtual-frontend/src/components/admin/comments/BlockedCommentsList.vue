<template>
    <div class="container my-30" style="min-height: 820px;" :style="mode==='dark'?'background: #080035; color: #fff':''">
        <section class="hk-sec-wrapper">
            <h3 class="hk-sec-title text-center" :class="mode==='dark'?'text-primary':''">{{ $t('administrador.componentes.comentarios_bloqueados') }}</h3>
            <div class="row justify-content-between mt-20 px-10">
                ...
                <div class="input-group col-md-6 col-xl-4 my-5">
                    ...
                    <div class="input-group-append">
                        <button @click="getComments(1)" class="btn btn-primary"><i class="fas fa-search"></i></button>
                    </div>
                </div>
            </div>
                            ...
                            <td v-for="column in data.columns" :key="'comment-' + comment.id + '-' + column.field">
                                ...
                                <div v-else-if="column.field === 'actions'" class="text-center">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" :href="'/admin/blocked/' + comment.id">Ver</a>
