            ...
            <div class="row">
                <div class="col-xl-12">
                    <section class="hk-sec-wrapper" v-if="loader">
                        <div class="row">
                            <div class="col-xl-12">
                                <h3 class="hk-sec-title text-center" :class="mode==='dark'?'text-primary':''">{{ $t('administrador.componentes.menu') }}</h3>
                                <hr class="my-4">
                            </div>
                        </div>
                        <div class="row">
            ...
            if (node.enabled()) {
                ...
                if (node.data.padreDePadres) {
                    ...
                    node.append({ 
                        ...
                        state: { expanded: false },
                        data: { icon: 'fa fa-folder-open', editable: true, eliminable: true, heredable: true, parent_id: node.id, url: '#', padreDePadres: false, pages: true }
                    })
    ...
    async mounted() {
        ...
        try {
            ...
            this.treeData.push({
                ...
                data: { icon: 'fa fa-bars', editable: false, eliminable: false, heredable: true, padreDePadres: true, pages: false },
                state: { expanded: true },
