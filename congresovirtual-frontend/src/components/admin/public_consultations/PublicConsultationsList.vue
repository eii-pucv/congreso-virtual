<template>
    <div class="container my-30" style="min-height: 820px;" :style="mode==='dark'?'background: #080035; color: #fff':''">
        <section class="hk-sec-wrapper">
            ...
            <div class="row px-10">
                <div class="col-sm">
                    <router-link class="btn btn-sm btn-labeled btn-success float-right" :to="{ path: '/admin/public_consultation' }">
            ...
            <div class="row justify-content-between mt-20 px-10">
                ...
                <div class="input-group col-md-6 col-xl-4 my-5">
                    ...
                    <div class="input-group-append">
                        <button @click="getPublicConsultations(1)" class="btn btn-primary"><i class="fas fa-search"></i></button>
                    </div>
                </div>
            </div>
                            ...
                            <td v-for="column in data.columns" :key="'public-consultation-' + publicConsultation.id + '-' + column.field">
                                ...
                                <div v-else-if="column.field === 'actions'" class="text-center">
                                    ...
                                    <div class="dropdown-menu">
                                        <router-link class="dropdown-item" :to="{ path: '/admin/public_consultation/' + publicConsultation.id }">{{ $t('editar') }}</router-link>
                                        <router-link class="dropdown-item" :to="{ path: '/admin/public_consultation/' + publicConsultation.id + '/delete' }">{{ $t('eliminar') }}</router-link>
                                    </div>
                                </div>
                            </td>
                        </tr>
